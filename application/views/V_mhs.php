      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url() ?>admin/dist/img/avatar5.png" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url() ?>admin/dist/img/avatar5.png" class="user-image" alt="User Image">
              <span class="hidden-xs">Catur Juliaming Rizqi Putra</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          <a href="#">
            <i class="fa fa-table"></i> <span>Edit</span>
            <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('Con_mhs/hasiledit');?>"><i class="fa fa-circle-o"></i> Lihat Hasil Edit</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <center>
			<h5>
			<a href="<?php echo base_url('Con_mhs/tambahmhs');?>">Tambah </a>
			</h5>
			</center>
        ...
        <tr>
          ...
          <th><?php echo $itemmhs['nmmahasiswa']; ?></th>
          <th><?php echo $itemmhs['jk']; ?></th>
          <th><?php echo $itemmhs['alamat']; ?></th>
          <th><?php echo $itemmhs['nohp']; ?></th>
          <td align ="center">
            <a href="<?php echo base_url('Con_mhs/editmhs/').$itemmhs['id']; ?>">Edit</a>
